 ...
 *
 */
public class UVJobResultExportHandler implements JobResultExportHandler {
	private final static String SQL_INSERT = "insert into STAT_UV values (?,?,?)";
