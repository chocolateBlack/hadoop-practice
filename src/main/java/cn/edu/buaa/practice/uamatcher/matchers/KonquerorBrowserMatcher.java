 ...
 *
 */
public class KonquerorBrowserMatcher implements Matcher {
	private final static String BROWSER_NAME = "Konqueror";
	...
	public void match(String userAgent, UserAgentInfo userAgentInfo, int beginIndex) {
		...
		if(userAgent.charAt(beginIndex) == '/') {
			String browserVersion = StringUtils.getNextToken(userAgent, DILIMITERS, ++beginIndex, 16);
